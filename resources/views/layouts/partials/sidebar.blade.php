...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ route('dashboard') }}" class="brand-link">
        ...
        <span class="brand-text font-weight-light">Dashboard PWL</span>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-6">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item {{ request()->routeIs('marketing.*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ request()->routeIs('marketing.*') ? 'active' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="{{ route('marketing.index') }}"
                                class="nav-link {{ request()->routeIs('marketing.index') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
                                <p>Daftar Marketing</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('marketing.create') }}"
                                class="nav-link {{ request()->routeIs('marketing.create') ? 'active' : '' }}">
                                <i class="far fa-circle nav-icon"></i>
